...
export const metadata: Metadata = { title: 'Learning Portal', description: 'KVL School online learning management system' }
      ...
      <main>
        <section className="bg-navy-900 py-20">
          <div className="container-premium text-center">
            ...
            <h1 className="font-display text-5xl font-bold text-white mb-4">Learning Portal</h1>
            <p className="text-ivory-300 max-w-xl mx-auto">Access recorded classes, assignments, and learning resources.</p>
          </div>
        </section>
