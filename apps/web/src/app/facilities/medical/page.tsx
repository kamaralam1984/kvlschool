...
export const metadata: Metadata = { title: 'Medical Center', description: 'KVL School medical and health facilities' }
      ...
      <main>
        <section className="bg-navy-900 py-20">
          <div className="container-premium text-center">
            ...
            <h1 className="font-display text-5xl font-bold text-white mb-4">Medical Center</h1>
            <p className="text-ivory-300 max-w-xl mx-auto">Full-time medical staff ensuring the health and wellbeing of every student.</p>
          </div>
        </section>
