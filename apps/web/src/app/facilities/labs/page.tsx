...
export const metadata: Metadata = { title: 'Science Laboratories', description: 'KVL School science labs' }
      ...
      <main>
        <section className="bg-navy-900 py-20">
          <div className="container-premium text-center">
            ...
            <h1 className="font-display text-5xl font-bold text-white mb-4">Science Laboratories</h1>
            <p className="text-ivory-300 max-w-xl mx-auto">12 fully-equipped labs including Physics, Chemistry, Biology, and Robotics.</p>
          </div>
        </section>
