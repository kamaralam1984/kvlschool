...
export const metadata: Metadata = { title: 'Sports Complex', description: 'KVL School sports and athletics facilities' }
      ...
      <main>
        <section className="bg-navy-900 py-20">
          <div className="container-premium text-center">
            ...
            <h1 className="font-display text-5xl font-bold text-white mb-4">Sports Complex</h1>
            <p className="text-ivory-300 max-w-xl mx-auto">Olympic-standard facilities — track, pool, courts, gymnasium, and more.</p>
          </div>
        </section>
