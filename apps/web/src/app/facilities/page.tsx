...
export const metadata: Metadata = { title: 'Facilities', description: 'KVL School world-class facilities' }
      ...
      <main>
        <section className="bg-navy-900 py-20">
          <div className="container-premium text-center">
            ...
            <h1 className="font-display text-5xl font-bold text-white mb-4">Our Facilities</h1>
            <p className="text-ivory-300 max-w-xl mx-auto">State-of-the-art infrastructure across 12 acres of our New Delhi campus.</p>
          </div>
        </section>
