...
export const metadata: Metadata = { title: 'Hostel', description: 'KVL School hostel and residential facilities' }
      ...
      <main>
        <section className="bg-navy-900 py-20">
          <div className="container-premium text-center">
            ...
            <h1 className="font-display text-5xl font-bold text-white mb-4">Hostel Facilities</h1>
            <p className="text-ivory-300 max-w-xl mx-auto">Safe, modern residential facilities with 24/7 security and care.</p>
          </div>
        </section>
