...
export const metadata: Metadata = { title: 'Transport', description: 'KVL School transport and bus services' }
      ...
      <main>
        <section className="bg-navy-900 py-20">
          <div className="container-premium text-center">
            ...
            <h1 className="font-display text-5xl font-bold text-white mb-4">Transport Services</h1>
            <p className="text-ivory-300 max-w-xl mx-auto">GPS-tracked fleet covering 80+ stops across the city.</p>
          </div>
        </section>
