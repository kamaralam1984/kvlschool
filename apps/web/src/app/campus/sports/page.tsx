...
export const metadata: Metadata = { title: 'Sports & Athletics', description: 'KVL School sports programs' }
      ...
      <main>
        <section className="bg-navy-900 py-20">
          <div className="container-premium text-center">
            ...
            <h1 className="font-display text-5xl font-bold text-white mb-4">Sports & Athletics</h1>
            <p className="text-ivory-300 max-w-xl mx-auto">Developing champions on and off the field.</p>
          </div>
        </section>
