...
export const metadata: Metadata = { title: 'Clubs & Societies', description: 'KVL School student clubs and societies' }
      ...
      <main>
        <section className="bg-navy-900 py-20">
          <div className="container-premium text-center">
            ...
            <h1 className="font-display text-5xl font-bold text-white mb-4">Clubs & Societies</h1>
            <p className="text-ivory-300 max-w-xl mx-auto">40+ clubs spanning science, debate, environment, robotics, and more.</p>
          </div>
        </section>
