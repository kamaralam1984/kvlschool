...
export const metadata: Metadata = { title: 'Privacy Policy', description: 'KVL School privacy policy' }
      ...
      <main>
        <section className="bg-navy-900 py-20">
          <div className="container-premium text-center">
            ...
            <p className="text-ivory-300 max-w-xl mx-auto">How we collect, use, and protect your personal information.</p>
          </div>
        </section>
