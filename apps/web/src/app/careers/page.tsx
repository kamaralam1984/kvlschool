...
export const metadata: Metadata = { title: 'Careers at KVL', description: 'Job opportunities at KVL International School' }
      ...
      <main>
        <section className="bg-navy-900 py-20">
          <div className="container-premium text-center">
            ...
            <h1 className="font-display text-5xl font-bold text-white mb-4">Careers at KVL</h1>
            <p className="text-ivory-300 max-w-xl mx-auto">Join a team dedicated to transforming young minds.</p>
          </div>
        </section>
