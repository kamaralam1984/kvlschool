...
export const metadata: Metadata = { title: 'Exam Center', description: 'KVL School online exam center' }
      ...
      <main>
        <section className="bg-navy-900 py-20">
          <div className="container-premium text-center">
            ...
            <h1 className="font-display text-5xl font-bold text-white mb-4">Online Exam Center</h1>
            <p className="text-ivory-300 max-w-xl mx-auto">Schedule, attempt, and track your examinations online.</p>
          </div>
        </section>
