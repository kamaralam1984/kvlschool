...
export const metadata: Metadata = { title: 'Academics', description: 'KVL School academic programs and curriculum' }
      ...
      <main>
        <section className="bg-navy-900 py-20">
          <div className="container-premium text-center">
            ...
            <h1 className="font-display text-5xl font-bold text-white mb-4">Academic Programs</h1>
            <p className="text-ivory-300 max-w-xl mx-auto">A rigorous, holistic curriculum from Nursery to Class XII.</p>
          </div>
        </section>
