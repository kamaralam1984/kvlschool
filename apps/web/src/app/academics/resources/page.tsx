...
export const metadata: Metadata = { title: 'Learning Resources', description: 'KVL School learning resources and materials' }
      ...
      <main>
        <section className="bg-navy-900 py-20">
          <div className="container-premium text-center">
            ...
            <h1 className="font-display text-5xl font-bold text-white mb-4">Learning Resources</h1>
            <p className="text-ivory-300 max-w-xl mx-auto">Digital and physical resources to support your academic journey.</p>
          </div>
        </section>
