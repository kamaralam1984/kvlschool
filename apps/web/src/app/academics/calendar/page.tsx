...
export const metadata: Metadata = { title: 'Academic Calendar', description: 'KVL School academic calendar 2025-26' }
      ...
      <main>
        <section className="bg-navy-900 py-20">
          <div className="container-premium text-center">
            ...
            <h1 className="font-display text-5xl font-bold text-white mb-4">Academic Calendar 2025–26</h1>
            <p className="text-ivory-300 max-w-xl mx-auto">Important dates, exams, holidays, and events for the academic year.</p>
          </div>
        </section>
