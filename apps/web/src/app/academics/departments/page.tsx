...
export const metadata: Metadata = { title: 'Departments', description: 'KVL School academic departments' }
      ...
      <main>
        <section className="bg-navy-900 py-20">
          <div className="container-premium text-center">
            ...
            <h1 className="font-display text-5xl font-bold text-white mb-4">Academic Departments</h1>
            <p className="text-ivory-300 max-w-xl mx-auto">Expert faculty across Sciences, Humanities, Arts, Commerce, and Technology.</p>
          </div>
        </section>
