...
export const metadata: Metadata = { title: 'Curriculum', description: 'KVL School curriculum details' }
      ...
      <main>
        <section className="bg-navy-900 py-20">
          <div className="container-premium text-center">
            ...
            <h1 className="font-display text-5xl font-bold text-white mb-4">Our Curriculum</h1>
            <p className="text-ivory-300 max-w-xl mx-auto">CBSE curriculum enriched with co-curricular and 21st-century skills.</p>
          </div>
        </section>
