...
export const metadata: Metadata = { title: 'Alumni Network', description: 'KVL School alumni community' }
      ...
      <main>
        <section className="bg-navy-900 py-20">
          <div className="container-premium text-center">
            ...
            <h1 className="font-display text-5xl font-bold text-white mb-4">Alumni Network</h1>
            <p className="text-ivory-300 max-w-xl mx-auto">1,500+ alumni across the world — connected by the KVL spirit.</p>
          </div>
        </section>
