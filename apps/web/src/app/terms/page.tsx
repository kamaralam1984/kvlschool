...
export const metadata: Metadata = { title: 'Terms of Use', description: 'KVL School terms of use' }
      ...
      <main>
        <section className="bg-navy-900 py-20">
          <div className="container-premium text-center">
            ...
            <h1 className="font-display text-5xl font-bold text-white mb-4">Terms of Use</h1>
            <p className="text-ivory-300 max-w-xl mx-auto">Terms and conditions governing the use of our website and services.</p>
          </div>
        </section>
