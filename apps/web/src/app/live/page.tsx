...
export const metadata: Metadata = { title: 'Live Classes', description: 'KVL School live streaming classes' }
      ...
      <main>
        <section className="bg-navy-900 py-20">
          <div className="container-premium text-center">
            ...
            <h1 className="font-display text-5xl font-bold text-white mb-4">Live Classes</h1>
            <p className="text-ivory-300 max-w-xl mx-auto">Join live sessions with your teachers from anywhere.</p>
          </div>
        </section>
