...
export const metadata: Metadata = { title: 'Scholarships', description: 'KVL School scholarship programmes' }
      ...
      <main>
        <section className="bg-navy-900 py-20">
          <div className="container-premium text-center">
            ...
            <h1 className="font-display text-5xl font-bold text-white mb-4">Scholarships & Aid</h1>
            <p className="text-ivory-300 max-w-xl mx-auto">Merit-based and need-based scholarships making quality education accessible.</p>
          </div>
        </section>
