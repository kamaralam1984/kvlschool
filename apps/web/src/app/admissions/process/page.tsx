...
export const metadata: Metadata = { title: 'Admission Process', description: 'KVL School step-by-step admission process' }
      ...
      <main>
        <section className="bg-navy-900 py-20">
          <div className="container-premium text-center">
            ...
            <h1 className="font-display text-5xl font-bold text-white mb-4">Admission Process</h1>
            <p className="text-ivory-300 max-w-xl mx-auto">A transparent, merit-based admission process designed for every family.</p>
          </div>
        </section>
