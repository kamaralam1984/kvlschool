...
export const metadata: Metadata = { title: 'Admissions', description: 'KVL School admissions process and information' }
      ...
      <main>
        <section className="bg-navy-900 py-20">
          <div className="container-premium text-center">
            ...
            <h1 className="font-display text-5xl font-bold text-white mb-4">Admissions 2025–26</h1>
            <p className="text-ivory-300 max-w-xl mx-auto">Join KVL International School — admissions now open for all classes.</p>
          </div>
        </section>
