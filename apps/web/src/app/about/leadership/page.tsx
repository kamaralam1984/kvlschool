...
export const metadata: Metadata = { title: 'Leadership Team', description: 'KVL School leadership and management team' }
      ...
      <main>
        <section className="bg-navy-900 py-20">
          <div className="container-premium text-center">
            ...
            <h1 className="font-display text-5xl font-bold text-white mb-4">Leadership Team</h1>
            <p className="text-ivory-300 max-w-xl mx-auto">Meet the visionary leaders guiding KVL International School.</p>
          </div>
        </section>
