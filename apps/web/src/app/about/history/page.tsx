...
export const metadata: Metadata = { title: 'School History', description: 'History of KVL International School' }
      ...
      <main>
        <section className="bg-navy-900 py-20">
          <div className="container-premium text-center">
            ...
            <h1 className="font-display text-5xl font-bold text-white mb-4">School History</h1>
            <p className="text-ivory-300 max-w-xl mx-auto">Three decades of growth, achievement, and community impact.</p>
          </div>
        </section>
