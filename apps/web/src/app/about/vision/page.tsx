...
export const metadata: Metadata = { title: 'Vision & Mission', description: 'KVL School vision and mission' }
      ...
      <main>
        <section className="bg-navy-900 py-20">
          <div className="container-premium text-center">
            ...
            <h1 className="font-display text-5xl font-bold text-white mb-4">Vision & Mission</h1>
            <p className="text-ivory-300 max-w-xl mx-auto">Our purpose, values, and long-term educational philosophy.</p>
          </div>
        </section>
