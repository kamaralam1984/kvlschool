...
export const metadata: Metadata = { title: 'Infrastructure', description: 'KVL School campus and infrastructure' }
      ...
      <main>
        <section className="bg-navy-900 py-20">
          <div className="container-premium text-center">
            ...
            <h1 className="font-display text-5xl font-bold text-white mb-4">Infrastructure</h1>
            <p className="text-ivory-300 max-w-xl mx-auto">World-class facilities designed to inspire learning and growth.</p>
          </div>
        </section>
