...
export const metadata: Metadata = { title: 'Accreditation', description: 'KVL School accreditations and certifications' }
      ...
      <main>
        <section className="bg-navy-900 py-20">
          <div className="container-premium text-center">
            ...
            <h1 className="font-display text-5xl font-bold text-white mb-4">Accreditation</h1>
            <p className="text-ivory-300 max-w-xl mx-auto">Our affiliations, certifications, and institutional recognitions.</p>
          </div>
        </section>
